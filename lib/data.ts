...
export const transactions: Transaction[] = [
  { id: '1',  name: 'Apple Pay',    reference: 'TXN-2024-001', category: 'Platform',      categoryBg: 'rgba(124,92,252,0.12)', categoryColor: '#7C5CFC', date: '24 May 2026', time: '12:00 PM', type: 'Income',  amount: 345.00, status: 'Completed', icon: 'A', iconBg: 'rgba(255,255,255,0.06)', iconColor: '#fff' },
  { id: '2',  name: 'Google Pay',   reference: 'TXN-2024-002', category: 'Platform',      categoryBg: 'rgba(124,92,252,0.12)', categoryColor: '#7C5CFC', date: '23 May 2026', time: '01:23 PM', type: 'Expense', amount: 124.90, status: 'Completed', icon: 'G', iconBg: 'rgba(66,133,244,0.15)',  iconColor: '#4285F4' },
  { id: '3',  name: 'PayPal',       reference: 'TXN-2024-003', category: 'Transfer',      categoryBg: 'rgba(79,201,164,0.12)', categoryColor: '#4FC9A4', date: '22 May 2026', time: '02:40 PM', type: 'Income',  amount: 890.00, status: 'Completed', icon: 'P', iconBg: 'rgba(0,48,135,0.2)',    iconColor: '#4FC9A4' },
  { id: '4',  name: 'Figma',        reference: 'TXN-2024-004', category: 'Workspace',     categoryBg: 'rgba(245,166,35,0.12)',  categoryColor: '#F5A623', date: '21 May 2026', time: '04:12 PM', type: 'Expense', amount: 15.00,  status: 'Completed', icon: 'F', iconBg: 'rgba(242,78,30,0.15)',  iconColor: '#F24E1E' },
  { id: '5',  name: 'Spotify',      reference: 'TXN-2024-005', category: 'Entertainment', categoryBg: 'rgba(232,121,160,0.12)', categoryColor: '#E879A0', date: '20 May 2026', time: '05:30 PM', type: 'Expense', amount: 9.99,   status: 'Completed', icon: 'S', iconBg: 'rgba(29,185,84,0.15)',  iconColor: '#1DB954' },
  { id: '6',  name: 'YouTube',      reference: 'TXN-2024-006', category: 'Entertainment', categoryBg: 'rgba(232,121,160,0.12)', categoryColor: '#E879A0', date: '19 May 2026', time: '08:45 PM', type: 'Expense', amount: 11.99,  status: 'Completed', icon: 'Y', iconBg: 'rgba(255,0,0,0.15)',    iconColor: '#FF4444' },
